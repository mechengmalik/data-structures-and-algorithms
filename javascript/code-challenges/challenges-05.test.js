...
const addValues = (arr) => {
  // Solution code here...
  let newA = arr.reduce((acc,number)=>{
    return acc + number;
...
const returnNames = (arr) => {
  // Solution code here...
  let newA = arr.reduce((acc,characterName)=>{
    acc.push(characterName.name);
    return acc ;
